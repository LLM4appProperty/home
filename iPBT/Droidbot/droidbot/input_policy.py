...
from .input_event import InputEvent, KeyEvent, IntentEvent, KillAndRestartAppEvent, ReInstallAppEvent, TouchEvent, ManualEvent, SetTextEvent, KillAppEvent
from .utg import UTG
...
class UtgRandomPolicy(UtgBasedInputPolicy):
    ...
    def generate_event(self):
        ...
        if self.action_count % self.number_of_events_that_restart_app == 0:
            if self.clear_and_restart_app_data_after_100_events:
                self.logger.info(
